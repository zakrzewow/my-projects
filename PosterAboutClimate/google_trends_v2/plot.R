...
# Folder z danymi
dir_name <- file.path("google_trends_v2", "data")
...
speeches_dated <- readr::read_csv(file.path("google_trends_v2", "speeches.csv"))
...
ggsave("google_trends_v2/google_trends.svg", width = 8000, height = 4000, units = "px")
